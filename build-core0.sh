...
#Below is golden sample- do noet touch!
# arm-none-eabi-gcc -mcpu=cortex-m0plus -c -g -DLIB_PICO_STDIO_UART=1 -DPICO_UART_ENABLE_CRLF_SUPPORT=1 -DPICO_TIME_DEFAULT_ALARM_POOL_DISABLED=1 -DPICO_NO_RAM_VECTOR_TABLE=1 -DPICO_DISABLE_SHARED_IRQ_HANDLERS=1 ${PICO_SDK_INC[@]/#/-I} core1-startup.S ../pico-sdk/src/rp2_common/hardware_claim/claim.c ../pico-sdk/src/rp2_common/hardware_timer/timer.c ../pico-sdk/src/rp2_common/hardware_xosc/xosc.c ../pico-sdk/src/rp2_common/pico_platform/platform.c ../pico-sdk/src/rp2_common/hardware_watchdog/watchdog.c ../pico-sdk/src/rp2_common/hardware_pll/pll.c ../pico-sdk/src/rp2_common/hardware_irq/irq.c ../pico-sdk/src/rp2_common/hardware_clocks/clocks.c ../pico-sdk/src/rp2_common/hardware_gpio/gpio.c ../pico-sdk/src/rp2_common/hardware_uart/uart.c main.c stubs.c
# arm-none-eabi-ld core1-startup.o claim.o timer.o xosc.o platform.o watchdog.o pll.o irq.o clocks.o gpio.o uart.o main.o stubs.o /usr/lib/gcc/arm-none-eabi/9.2.1/thumb/v6-m/nofp/libgcc.a -T linker-core1.ld -Map=core1.map -o core1.elf
# arm-none-eabi-objcopy core1.elf -O binary core1.bin

arm-none-eabi-gcc -mcpu=cortex-m0plus -c -g -DLIB_PICO_STDIO_UART=1 -DPICO_UART_ENABLE_CRLF_SUPPORT=1 -DPICO_TIME_DEFAULT_ALARM_POOL_DISABLED=1 -DPICO_NO_RAM_VECTOR_TABLE=1 -DPICO_DISABLE_SHARED_IRQ_HANDLERS=1 ${PICO_SDK_INC[@]/#/-I} startup-core0.S ../pico-sdk/src/rp2_common/hardware_claim/claim.c ../pico-sdk/src/rp2_common/hardware_timer/timer.c ../pico-sdk/src/rp2_common/hardware_xosc/xosc.c ../pico-sdk/src/rp2_common/pico_platform/platform.c ../pico-sdk/src/rp2_common/hardware_watchdog/watchdog.c ../pico-sdk/src/rp2_common/hardware_pll/pll.c ../pico-sdk/src/rp2_common/hardware_irq/irq.c ../pico-sdk/src/rp2_common/hardware_clocks/clocks.c ../pico-sdk/src/rp2_common/hardware_gpio/gpio.c ../pico-sdk/src/rp2_common/hardware_uart/uart.c main.c stubs.c
arm-none-eabi-ld startup-core0.o claim.o timer.o xosc.o platform.o watchdog.o pll.o irq.o clocks.o gpio.o uart.o main.o stubs.o /usr/lib/gcc/arm-none-eabi/10.3.1/thumb/v6-m/nofp/libgcc.a -T linker-core0.ld -Map=core0.map -o core0.elf
